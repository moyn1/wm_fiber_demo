/**************************************************************************
  ...
  Description:
    ...
    application running on the QuEST Wayside Mux Development board.
  **************************************************************************/
...
typedef enum
{
    DS_1 = PORTS_BIT_POS_0,
    DS_2 = PORTS_BIT_POS_1,
    DS_3 = PORTS_BIT_POS_2,
    DS_4 = PORTS_BIT_POS_3,
    DS_5 = PORTS_BIT_POS_4,
    DS_6 = PORTS_BIT_POS_5,
    DS_7 = PORTS_BIT_POS_6,
    DS_8 = PORTS_BIT_POS_7,
    PBTN_1 = PORTS_BIT_POS_8,
    PBTN_2 = PORTS_BIT_POS_9
} BSP_SWITCH;
...
typedef enum
{
    SWITCH_OFF = /*DOM-IGNORE-BEGIN*/0/*DOM-IGNORE-END*/,
    SWITCH_ON = /*DOM-IGNORE-BEGIN*/1/*DOM-IGNORE-END*/,
    SWITCH_INV,
    BTN_PRESSED = /*DOM-IGNORE-BEGIN*/0/*DOM-IGNORE-END*/,
    BTN_RELEASED = /*DOM-IGNORE-BEGIN*/1/*DOM-IGNORE-END*/
...
typedef enum
{
    ...
    STATUS_GRN = PORTS_BIT_POS_12,
    STATUS_RED = PORTS_BIT_POS_13
} BSP_LED;
...
{
    /* LED State is on */
    LED_OFF = /*DOM-IGNORE-BEGIN*/0/*DOM-IGNORE-END*/,
    /* LED State is off */
    LED_ON = /*DOM-IGNORE-BEGIN*/1/*DOM-IGNORE-END*/
